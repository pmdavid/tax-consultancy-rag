...
st.set_page_config(
    page_title="Gestoría | Asistente IA",
    page_icon="🤖",
    layout="wide"
)

# Título
st.title("🤖 Gestoría - Asistente IA")
st.divider()
...
# Input del usuario
if prompt := st.chat_input("Escribe tu consulta aquí, sobre clientes, trámites, obligaciones fiscales, etc..."):
...
st.divider()
st.markdown(
    "<div style='text-align: center; color: #666;'>🤖 Asistente Gestoría | RAG</div>",
